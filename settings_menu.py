...
def drawTitle(SCALE, settingsSurface, BORDER_WIDTH):
    ...
    titleContainer.drawText(settingsSurface, int(128 * SCALE), int((266 - 6) * SCALE), int(27 * SCALE), "Settings", categoryTitleColor)
...
def drawAppearanceCatHeader(SCALE, settingsSurface):
    ...
    appearanceCatHeader.drawText(settingsSurface, int(131 * SCALE), int((341 - 6) * SCALE), int(25 * SCALE), "Appearance", categoryTitleColor)
...
def drawAppearanceCatBody(SCALE, settingsSurface):
    ...
    appearanceCatBody.drawText(settingsSurface, int(120 * SCALE), int((396 - 2) * SCALE), int(20 * SCALE), "Primary color", subCatTitleTextColor)
    pygame.draw.aaline(settingsSurface, subCatLineColor, (int(100 * SCALE), int(436 * SCALE)), (int(400 * SCALE), int(436 * SCALE)))
    appearanceCatBody.drawText(settingsSurface, int(120 * SCALE), int((456 - 2) * SCALE), int(20 * SCALE), "Secondary color", subCatTitleTextColor)
    pygame.draw.aaline(settingsSurface, subCatLineColor, (int(100 * SCALE), int(496 * SCALE)), (int(400 * SCALE), int(496 * SCALE)))
    appearanceCatBody.drawText(settingsSurface, int(120 * SCALE), int((516 - 2) * SCALE), int(20 * SCALE), "Pieces style", subCatTitleTextColor)
...
def drawGameplayCatHeader(SCALE, settingsSurface):
    ...
    gameplayCatHeader.drawText(settingsSurface, int(131 * SCALE), int((599 - 6) * SCALE), int(25 * SCALE), "Gameplay", categoryTitleColor)
...
def drawGameplayCatBody(SCALE, settingsSurface):
    ...
    gameplayCatBody.drawText(settingsSurface, int(120 * SCALE), int((654 - 2) * SCALE), int(20 * SCALE), "Show possible moves", subCatTitleTextColor)
    pygame.draw.aaline(settingsSurface, subCatLineColor, (int(100 * SCALE), int(694 * SCALE)), (int(700 * SCALE), int(694 * SCALE)))
    gameplayCatBody.drawText(settingsSurface, int(120 * SCALE), int((714 - 2) * SCALE), int(20 * SCALE), "Enable sounds", subCatTitleTextColor)
